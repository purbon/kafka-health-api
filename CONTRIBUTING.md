# Contributing to Kafka Health API
...
* File a ticket on [GitHub](https://github.com/purbon/kafka-health-api/issues). 

## Something Not Working? Found a Bug? or a Security Issue?

If you think you found a bug, it probably is a bug.

* File it in [Kafka Health API GitHub](https://github.com/purbon/kafka-health-api/issues)
...
You can reach us via [GitHub](https://github.com/purbon/kafka-health-api/issues).
...
See: https://github.com/purbon/kafka-health-api/labels/adoptme
https://github.com/purbon/kafka-health-api/labels/low%20hanging%20fruit
...
1. Test your changes! [Run](https://github.com/purbon/kafka-health-api#testing) the test suite
